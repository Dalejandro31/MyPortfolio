      ...
      <main className="bg-white px-10 md:px-20 lg:px-20 dark:bg-gray-900">
        <section className="min-h-screen">
          ...
          <div className="text-center p-10">
            <h1 className="text-2xl py-2 md:text-3xl2 font-mono dark:text-white">
        ...
        <section> 
          <div className="dark:text-gray-300 mt-8 text-center">
            ...
            I am a passionate FullStack developer dedicated to building robust and scalable solutions. My fascination with technology 
            and development began at the age of 19, igniting a deep passion for programming within me. Since then, I have focused my 
            career on systems engineering and engage in projects that allow me to continue growing as a programmer.

            My true passion lies in finding solutions to real-life situations through code. I am committed to tackling challenges 
